# Offline First - Progressive Web App (React): Task List

![tasklist-home-v2](https://user-images.githubusercontent.com/11150895/170887640-f81f168e-b1c1-4560-92ae-430cad516490.png)

Task List is a **Progressive Web App** built with React as part of my book [Implementing PWA with React](https://leanpub.com/pwawithreact). This **version 2** now works as an **offline first** application . It is an installable app, with the app shell cached (using cache first strategy). It uses [idb](https://github.com/jakearchibald/idb), a thin wrapper of IndexedDB, to store the taks items. And it uses the [Background Sync](https://docs.microsoft.com/en-us/microsoft-edge/progressive-web-apps-chromium/how-to/background-syncs) service to keep the data updated in a backend.
